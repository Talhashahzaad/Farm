                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="serviceForm" action="{{ route('admin.service.update', $service->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control" id="category">
                                                @foreach ($category as $categories)
                                                    <option @selected($service->category == $categories->id) value="{{ $categories->id }}">
                                                ...
                                                <div class="variation-row">
                                                    <div class="row align-items-center">
                                                        <div class="col-md-3 variant-name">
                                                            <strong>{{ $variant->name ?: 'Service' }}</strong>
                                                            <input type="hidden" name="variant_id[]"
                                                                value="{{ $variant->id }}">
                                                            <input type="hidden" name="variant_name[]"
                                                                value="{{ $variant->name }}">
                                                            <input type="hidden" name="variant_description[]"
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <select class="form-control price-type" name="price_type[]">
                                                                @foreach (['Free', 'From', 'Fixed'] as $priceType)
                                                                    <option value="{{ $priceType }}"
                                                                        {{ $variant->price_type == $priceType ? 'selected' : '' }}>
                                                                        {{ $priceType }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                ...
                                <input type="hidden" name="price" id="priceData">
    ...
    `;
            ...
            $('#serviceForm').on('submit', function(e) {
                ...
                $('.variation-row').each(function() {
                    var variantId = $(this).find('input[name="variant_id[]"]').val();
                ...
                $('#priceData').val(JSON.stringify(prices));
