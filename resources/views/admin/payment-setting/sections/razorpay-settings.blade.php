                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="razorpay_country" class="form-control select2">
                                ...
                                @foreach (config('countries') as $key => $country)
                                    <option @selected($key === config('payment.razorpay_country')) value="{{ $key }}">{{ $country }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <Select name="razorpay_currency" class="form-control select2">
                                ...
                                @foreach (config('currencies.currency_list') as $key => $currency)
                                    <option @selected($currency == config('payment.razorpay_currency')) value="{{ $currency }}">{{ $key }}
                                        ({{ $currency }})
                                    </option>
                                @endforeach
                            </Select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="razorpay_currency_rate"
